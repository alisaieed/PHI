...
class HrContract(models.Model):
    ...
    technical_allowance = fields.Monetary(string='Technical Allowance', help="Technical allowance.")
    ...
    compensatory_allowance = fields.Monetary(string="Compensatory Allowance", help="Compensatory allowance")
    additional_allowance = fields.Monetary(string="Additional Allowance", help="Additional allowance")
